...
- Generated TypeScript sources from protos: `src/generated/`
...
import {
  ...
  CreateBucketRequest,
} from './src/generated/nebius/storage/v1';
...
See [OperationService](docs/api/generated/nebius/common/v1/classes/OperationService.md) and the service `getOperationService()` docs (for example: [BucketService](docs/api/generated/nebius/storage/v1/classes/BucketService.md)).

### Update / reset-mask helpers

When performing partial updates, the generated types and helpers follow the usual pattern: construct an update request and provide update masks where required. See the generated service docs (for example [BucketService](docs/api/generated/nebius/storage/v1/classes/BucketService.md)) for the exact request shapes and helper methods.
...
- Generated code in `src/generated/` is ignored by the linters. Do not edit generated files by hand.
