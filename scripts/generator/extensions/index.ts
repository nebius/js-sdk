...
export type ResourceBehavior = EnumInstance<
  'UNRECOGNIZED' | 'RESOURCE_BEHAVIOR_UNSPECIFIED' | 'MOVABLE' | 'UNNAMED' | 'IMMUTABLE_NAME'
>;
...
interface ResourceBehaviorValueMembers {
   ...
   *
   */
  readonly RESOURCE_BEHAVIOR_UNSPECIFIED: EnumInstance<
    'UNRECOGNIZED' | 'RESOURCE_BEHAVIOR_UNSPECIFIED' | 'MOVABLE' | 'UNNAMED' | 'IMMUTABLE_NAME'
  >;
  /**
   ...
   *
   */
  readonly IMMUTABLE_NAME: EnumInstance<
    'UNRECOGNIZED' | 'RESOURCE_BEHAVIOR_UNSPECIFIED' | 'MOVABLE' | 'UNNAMED' | 'IMMUTABLE_NAME'
  >;
}
type ResourceBehaviorClass = EnumClass<
  'UNRECOGNIZED' | 'RESOURCE_BEHAVIOR_UNSPECIFIED' | 'MOVABLE' | 'UNNAMED' | 'IMMUTABLE_NAME'
> &
  ResourceBehaviorValueMembers;
...
export const ResourceBehavior = createEnum(
  ...
  ResourceBehavior_VALUE_COMMENTS,
) as ResourceBehaviorClass;

protoRegistry.registerEnum(ResourceBehavior);

export type FieldBehavior = EnumInstance<
  | 'UNRECOGNIZED'
...
interface FieldBehaviorValueMembers {
  readonly FIELD_BEHAVIOR_UNSPECIFIED: EnumInstance<
    | 'UNRECOGNIZED'
    | 'FIELD_BEHAVIOR_UNSPECIFIED'
    | 'IMMUTABLE'
    | 'IDENTIFIER'
   ...
   *
   */
  readonly IMMUTABLE: EnumInstance<
    | 'UNRECOGNIZED'
    | 'FIELD_BEHAVIOR_UNSPECIFIED'
    | 'IMMUTABLE'
    | 'IDENTIFIER'
   ...
   *
   */
  readonly IDENTIFIER: EnumInstance<
    | 'UNRECOGNIZED'
    | 'FIELD_BEHAVIOR_UNSPECIFIED'
    | 'IMMUTABLE'
    | 'IDENTIFIER'
   ...
   *
   */
  readonly INPUT_ONLY: EnumInstance<
    | 'UNRECOGNIZED'
    | 'FIELD_BEHAVIOR_UNSPECIFIED'
    | 'IMMUTABLE'
    | 'IDENTIFIER'
   ...
   *
   */
  readonly OUTPUT_ONLY: EnumInstance<
    | 'UNRECOGNIZED'
    | 'FIELD_BEHAVIOR_UNSPECIFIED'
    | 'IMMUTABLE'
    | 'IDENTIFIER'
   ...
   *
   */
  readonly MEANINGFUL_EMPTY_VALUE: EnumInstance<
    | 'UNRECOGNIZED'
    | 'FIELD_BEHAVIOR_UNSPECIFIED'
    | 'IMMUTABLE'
    | 'IDENTIFIER'
   ...
   *
   */
  readonly NON_EMPTY_DEFAULT: EnumInstance<
    | 'UNRECOGNIZED'
    | 'FIELD_BEHAVIOR_UNSPECIFIED'
    | 'IMMUTABLE'
    | 'IDENTIFIER'
...
type FieldBehaviorClass = EnumClass<
  | 'UNRECOGNIZED'
  | 'FIELD_BEHAVIOR_UNSPECIFIED'
  | 'IMMUTABLE'
  | 'IDENTIFIER'
...
export const FieldBehavior = createEnum(
  ...
  FieldBehavior_VALUE_COMMENTS,
) as FieldBehaviorClass;
...
export const ServicePySDKSettings: MessageFns<ServicePySDKSettings, 'nebius.ServicePySDKSettings'> =
  {
    ...
    fromJSON(object: any): ServicePySDKSettings {
      return {
        $type: 'nebius.ServicePySDKSettings',
        name: isSet(object.name ?? object.name) ? String(object.name ?? object.name) : '',
      };
    },
    ...
    fromPartial<I extends DeepPartial<ServicePySDKSettings>>(object: I): ServicePySDKSettings {
      const message = createBaseServicePySDKSettings();
      message.name = object.name !== undefined && object.name !== null ? object.name : '';
      return message;
    },
  };
...
export const EnumValuePySDKSettings: MessageFns<
...
export const RegionRouting: MessageFns<RegionRouting, 'nebius.RegionRouting'> = {
  ...
  fromPartial<I extends DeepPartial<RegionRouting>>(object: I): RegionRouting {
    ...
    message.disabled =
      object.disabled !== undefined && object.disabled !== null ? object.disabled : false;
    message.strict = object.strict !== undefined && object.strict !== null ? object.strict : false;
    return message;
  },
};
...
export const DeprecationDetails: MessageFns<DeprecationDetails, 'nebius.DeprecationDetails'> = {
  ...
  fromPartial<I extends DeepPartial<DeprecationDetails>>(object: I): DeprecationDetails {
    const message = createBaseDeprecationDetails();
    message.effectiveAt =
      object.effectiveAt !== undefined && object.effectiveAt !== null ? object.effectiveAt : '';
    message.description =
      object.description !== undefined && object.description !== null ? object.description : '';
    return message;
  },
};
...
import '../protos/protobuf/index';
// ensure module exists for augmentation
...
protoRegistry.registerExtension({
  ...
  toJSON(message, obj, use) {
    ...
    if (_val !== undefined)
      obj[use === 'json' ? 'serviceDeprecationDetails' : 'service_deprecation_details'] =
        DeprecationDetails.toJSON(_val, use);
  },
});
...
protoRegistry.registerExtension({
  ...
  toJSON(message, obj, use) {
    ...
    if (_val !== undefined)
      obj[use === 'json' ? 'servicePySdk' : 'service_py_sdk'] = ServicePySDKSettings.toJSON(
        _val,
        use,
      );
  },
...
protoRegistry.registerExtension({
  ...
  toJSON(message, obj, use) {
    ...
    if (_val !== undefined)
      obj[use === 'json' ? 'methodDeprecationDetails' : 'method_deprecation_details'] =
        DeprecationDetails.toJSON(_val, use);
  },
});
...
protoRegistry.registerExtension({
  ...
  toJSON(message, obj, use) {
    ...
    if (_val !== undefined)
      obj[use === 'json' ? 'methodPySdk' : 'method_py_sdk'] = MethodPySDKSettings.toJSON(_val, use);
  },
});
...
protoRegistry.registerExtension({
  ...
  toJSON(message, obj, use) {
    ...
    if (_val !== undefined)
      obj[use === 'json' ? 'regionRouting' : 'region_routing'] = RegionRouting.toJSON(_val, use);
  },
});
...
protoRegistry.registerExtension({
  ...
  toJSON(message, obj, use) {
    ...
    if (_val?.length) {
      obj[use === 'json' ? 'resourceBehavior' : 'resource_behavior'] = _val.map((e: any) =>
        ResourceBehavior.toJSON(e),
      );
    }
  },
});
...
protoRegistry.registerExtension({
  ...
  toJSON(message, obj, use) {
    ...
    if (_val !== undefined)
      obj[use === 'json' ? 'messageDeprecationDetails' : 'message_deprecation_details'] =
        DeprecationDetails.toJSON(_val, use);
  },
});
...
protoRegistry.registerExtension({
  ...
  toJSON(message, obj, use) {
    ...
    if (_val !== undefined)
      obj[use === 'json' ? 'messagePySdk' : 'message_py_sdk'] = MessagePySDKSettings.toJSON(
        _val,
        use,
      );
  },
...
protoRegistry.registerExtension({
  ...
  toJSON(message, obj, use) {
    ...
    if (_val?.length) {
      obj[use === 'json' ? 'fieldBehavior' : 'field_behavior'] = _val.map((e: any) =>
        FieldBehavior.toJSON(e),
      );
    }
  },
});
...
protoRegistry.registerExtension({
  ...
  toJSON(message, obj, use) {
    ...
    if (_val !== undefined)
      obj[use === 'json' ? 'fieldDeprecationDetails' : 'field_deprecation_details'] =
        DeprecationDetails.toJSON(_val, use);
  },
});
...
protoRegistry.registerExtension({
  ...
  toJSON(message, obj, use) {
    ...
    if (_val !== undefined)
      obj[use === 'json' ? 'fieldPySdk' : 'field_py_sdk'] = FieldPySDKSettings.toJSON(_val, use);
  },
});
...
protoRegistry.registerExtension({
  ...
  toJSON(message, obj, use) {
    ...
    if (_val?.length) {
      obj[use === 'json' ? 'oneofBehavior' : 'oneof_behavior'] = _val.map((e: any) =>
        FieldBehavior.toJSON(e),
      );
    }
  },
...
protoRegistry.registerExtension({
  ...
  toJSON(message, obj, use) {
    ...
    if (_val !== undefined)
      obj[use === 'json' ? 'oneofPySdk' : 'oneof_py_sdk'] = OneofPySDKSettings.toJSON(_val, use);
  },
});
...
protoRegistry.registerExtension({
  ...
  toJSON(message, obj, use) {
    ...
    if (_val !== undefined)
      obj[use === 'json' ? 'enumPySdk' : 'enum_py_sdk'] = EnumPySDKSettings.toJSON(_val, use);
  },
});
...
protoRegistry.registerExtension({
  ...
  toJSON(message, obj, use) {
    ...
    if (_val !== undefined)
      obj[use === 'json' ? 'enumValueDeprecationDetails' : 'enum_value_deprecation_details'] =
        DeprecationDetails.toJSON(_val, use);
  },
});
...
protoRegistry.registerExtension({
  ...
  toJSON(message, obj, use) {
    ...
    if (_val !== undefined)
      obj[use === 'json' ? 'enumValuePySdk' : 'enum_value_py_sdk'] = EnumValuePySDKSettings.toJSON(
        _val,
        use,
      );
  },
