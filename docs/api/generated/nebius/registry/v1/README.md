...
[@nebius/nodejs-sdk](../../../../README.md) / generated/nebius/registry/v1

# generated/nebius/registry/v1

## Classes

- [ArtifactService](classes/ArtifactService.md)
- [RegistryService](classes/RegistryService.md)

## Interfaces

- [Artifact](interfaces/Artifact.md)
- [ArtifactServiceBaseClient](interfaces/ArtifactServiceBaseClient.md)
- [ArtifactServiceServer](interfaces/ArtifactServiceServer.md)
...
- [RegistryServiceServer](interfaces/RegistryServiceServer.md)
- [RegistrySpec](interfaces/RegistrySpec.md)
- [RegistryStatus](interfaces/RegistryStatus.md)
...
- [DeleteArtifactRequest](variables/DeleteArtifactRequest.md)
- [DeleteRegistryRequest](variables/DeleteRegistryRequest.md)
- [GetArtifactRequest](variables/GetArtifactRequest.md)
- [GetRegistryRequest](variables/GetRegistryRequest.md)
- [ListArtifactsRequest](variables/ListArtifactsRequest.md)
- [ListArtifactsResponse](variables/ListArtifactsResponse.md)
- [ListRegistriesRequest](variables/ListRegistriesRequest.md)
- [ListRegistriesResponse](variables/ListRegistriesResponse.md)
- [Registry](variables/Registry.md)
- [RegistryServiceBaseClient](variables/RegistryServiceBaseClient.md)
