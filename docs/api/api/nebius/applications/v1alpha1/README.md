...
[@nebius/nodejs-sdk](../../../../README.md) / api/nebius/applications/v1alpha1

# api/nebius/applications/v1alpha1

## Classes

- [K8sReleaseService](classes/K8sReleaseService.md)
...
- [K8sReleaseServiceServer](interfaces/K8sReleaseServiceServer.md)
- [K8sReleaseSpec](interfaces/K8sReleaseSpec.md)
- [K8sReleaseStatus](interfaces/K8sReleaseStatus.md)
...
- [CreateK8sReleaseRequest](variables/CreateK8sReleaseRequest.md)
- [DeleteK8sReleaseRequest](variables/DeleteK8sReleaseRequest.md)
- [GetK8sReleaseRequest](variables/GetK8sReleaseRequest.md)
- [K8sRelease](variables/K8sRelease.md)
- [K8sReleaseServiceBaseClient](variables/K8sReleaseServiceBaseClient.md)
