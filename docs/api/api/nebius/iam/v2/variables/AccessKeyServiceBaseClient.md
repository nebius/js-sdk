...
[@nebius/nodejs-sdk](../../../../../README.md) / [api/nebius/iam/v2](../README.md) / AccessKeyServiceBaseClient
...
Defined in: src/api/nebius/iam/v2/index.ts:1482
...
#### service.activateByAwsId.requestSerialize()
...
#### service.activateByAwsId.requestStream

> `readonly` **requestStream**: `false` = `false`

#### service.activateByAwsId.responseDeserialize()
...
#### service.activateByAwsId.responseSerialize()
...
#### service.activateByAwsId.responseStream
...
#### service.deactivateByAwsId.requestSerialize()
...
#### service.deactivateByAwsId.requestStream

> `readonly` **requestStream**: `false` = `false`

#### service.deactivateByAwsId.responseDeserialize()
...
#### service.deactivateByAwsId.responseSerialize()
...
#### service.deactivateByAwsId.responseStream
...
#### service.deleteByAwsId.requestSerialize()
...
#### service.deleteByAwsId.requestStream

> `readonly` **requestStream**: `false` = `false`

#### service.deleteByAwsId.responseDeserialize()
...
#### service.deleteByAwsId.responseSerialize()
...
#### service.deleteByAwsId.responseStream
