...
[@nebius/nodejs-sdk](../../../../README.md) / api/nebius/iam/v2
...
- [TenantSpec](interfaces/TenantSpec.md)
- [TenantStatus](interfaces/TenantStatus.md)
...
- [DeactivateAccessKeyByAwsIdRequest](variables/DeactivateAccessKeyByAwsIdRequest.md)
- [DeactivateAccessKeyRequest](variables/DeactivateAccessKeyRequest.md)
- [DeleteAccessKeyByAwsIdRequest](variables/DeleteAccessKeyByAwsIdRequest.md)
...
- [GetAccessKeyRequest](variables/GetAccessKeyRequest.md)
- [GetTenantByNameRequest](variables/GetTenantByNameRequest.md)
