...
[@nebius/nodejs-sdk](../../../../../README.md) / [api/nebius/mk8s/v1alpha1](../README.md) / ClusterServiceServiceDescription

# Variable: ClusterServiceServiceDescription

> **ClusterServiceServiceDescription**: `object`

Defined in: src/api/nebius/mk8s/v1alpha1/index.ts:1022
...
> `readonly` **path**: `"/nebius.mk8s.v1alpha1.ClusterService/Create"` = `"/nebius.mk8s.v1alpha1.ClusterService/Create"`
...
> `readonly` **path**: `"/nebius.mk8s.v1alpha1.ClusterService/Delete"` = `"/nebius.mk8s.v1alpha1.ClusterService/Delete"`
...
> `readonly` **path**: `"/nebius.mk8s.v1alpha1.ClusterService/Get"` = `"/nebius.mk8s.v1alpha1.ClusterService/Get"`
...
> `readonly` **path**: `"/nebius.mk8s.v1alpha1.ClusterService/GetByName"` = `"/nebius.mk8s.v1alpha1.ClusterService/GetByName"`
...
> `readonly` **path**: `"/nebius.mk8s.v1alpha1.ClusterService/List"` = `"/nebius.mk8s.v1alpha1.ClusterService/List"`
...
> `readonly` **path**: `"/nebius.mk8s.v1alpha1.ClusterService/Update"` = `"/nebius.mk8s.v1alpha1.ClusterService/Update"`
