...
[@nebius/nodejs-sdk](../../../../README.md) / api/nebius/quotas/v1

# api/nebius/quotas/v1

## Classes

- [QuotaAllowanceService](classes/QuotaAllowanceService.md)
...
- [QuotaAllowanceServiceServer](interfaces/QuotaAllowanceServiceServer.md)
- [QuotaAllowanceSpec](interfaces/QuotaAllowanceSpec.md)
- [QuotaAllowanceStatus](interfaces/QuotaAllowanceStatus.md)
...
- [GetQuotaAllowanceRequest](variables/GetQuotaAllowanceRequest.md)
- [ListQuotaAllowancesRequest](variables/ListQuotaAllowancesRequest.md)
- [ListQuotaAllowancesResponse](variables/ListQuotaAllowancesResponse.md)
- [QuotaAllowance](variables/QuotaAllowance.md)
- [QuotaAllowanceServiceBaseClient](variables/QuotaAllowanceServiceBaseClient.md)
